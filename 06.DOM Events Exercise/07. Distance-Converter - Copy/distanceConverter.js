function attachEventsListeners() {
  ...
  let inputOption = document.querySelector('#inputUnits');
  let outPutOption = document.querySelector('#outputUnits');

  let buttonElement = document.getElementById('convert');

  buttonElement.addEventListener('click', operation);
